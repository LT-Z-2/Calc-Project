...
# define buttons, have to use lambda cuz using actual function won't work
...
button_mult   = Button(root, text="*", padx= 39, pady=20, command=lambda: button_click())
